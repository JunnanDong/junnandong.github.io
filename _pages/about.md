...
* <span style="font-family: Consolas; font-size: 16px; font:bold">
  <b>[KnowGPT: Black-Box Knowledge Injection for Large Language Models](https://arxiv.org/abs/2312.06185). </b></span>  <br>
    <font face="verdana" size=2>Qinggang Zhang*, <b>Junnan Dong*</b>(equal contribution), Hao Chen, Xiao Huang, Daochen Zha, Zailiang Yu <br>   
    <i>arXiv</i></font>
...
* <span style="font-family: Consolas; font-size: 16px; font:bold">
  <b>[Hierarchy-Aware Multi-Hop Question Answering over Knowledge Graphs](https://dl.acm.org/doi/10.1145/3543507.3583376). </b></span>  <br>
    ...
    <i>The ACM Web Conference</i> (<b>WWW</b>) [paper](https://dl.acm.org/doi/abs/10.1145/3543507.3583376) [code](https://github.com/DEEP-PolyU/HamQA_TheWebConf23)</font>
...
* <span style="font-family: Consolas; font-size: 16px; font:bold">
  <b>[Active Ensemble Learning for Knowledge Graph Error Detection](https://dl.acm.org/doi/10.1145/3539597.3570368). </b></span>  <br>
    ...
    <i>ACM International Conference on Web Search and Data Mining</i> (<b>WSDM</b>) [paper](https://dl.acm.org/doi/10.1145/3539597.3570368) [code](https://github.com/DEEP-PolyU/KAEL_WSDM23) </font>
