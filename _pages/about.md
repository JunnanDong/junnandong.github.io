...
<span style="font-family: Trebuchet MS; font-size: 15px; font:bold">1. Youtu-GraphRAG: Vertically Unified Agents for Graph Retrieval-Augmented Complex Reasoning</span><br>
...
<span style="font-family: Trebuchet MS; font-size: 15px; font:bold">2. Cost-efficient Knowledge-based Question Answering with Large Language Models.</span><br>
...
<span style="font-family: Trebuchet MS; font-size: 15px; font:bold">3. Modality-Aware Integration with Large Language Models for Knowledge-based VQA.</span><br>
...
<span style="font-family: Trebuchet MS; font-size: 15px">arXiv</span><br>
<span style="font-family: Trebuchet MS; font-size: 15px; font:bold">7. GraphRAG-Bench: Challenging Domain-Specific Reasoning for Graph Retrieval-Augmented Generation</span><br>
...
<span style="font-family: Trebuchet MS; font-size: 15px">arxiv</span><br>
<span style="font-family: Trebuchet MS; font-size: 15px; font:bold">8. HyperRAG: Query-centric Graph Retrieval-Augmented Generation with Adaptive Knowledge Structuring</span><br>
...
<span style="font-family: Trebuchet MS; font-size: 15px">arxiv</span><br>
<span style="font-family: Trebuchet MS; font-size: 15px; font:bold">9. KnowGPT: Knowledge Graph Prompting for Large Language Models.</span><br>
