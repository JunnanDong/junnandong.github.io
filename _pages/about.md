...
<span style="font-size: 8px;">I am currently a first-year PhD student in DEEP Lab at The Hong Kong Polytechnic University, Department of Computing, supervised by [Dr. Xiao Huang](https://www4.comp.polyu.edu.hk/~xiaohuang/index.html "Redirecting to Dr.Huang's homepage"). </span>

<span style="font-size: 8x;">My research interests lie in Data Mining and Graph Learning, especially in exploring Knowledge-enhanced Reasoning. I'm still on my way towards a smart data researcher.</span>

<span style="font-size: 8px;">Contact: hanson[dot]dong[at]connect[dot]polyu[dot]hk </span>
