...
<span style="font-family: Trebuchet MS; font-size: 16px">I am now a senior researcher at Tencent Youtu Lab, specializing in the research of Graph-enhanced Large Language Models and LLM-based applications, e.g., Agents. I obtained my Ph.D. degree from The Hong Kong Polytechnic University, Department of Computing, supervised by [Prof. Xiao Huang](https://web.comp.polyu.edu.hk/xiaohuang/index.html) and [Prof. Qing Li](https://www4.comp.polyu.edu.hk/~csqli/). I was nominated by both the Department of Computing and the Faculty of Computer and Mathematical Science as the '**Best Research Postgraduate Student**' of 2024.</span>

<span style="font-family: Trebuchet MS; font-size: 16px">My current research interests focus on <b>Large Language Models</b>, <b>Agents</b> and <b>Graphs</b>, especially in exploring <b>Agents</b> for various domains-specific scenarios.</span><br>
