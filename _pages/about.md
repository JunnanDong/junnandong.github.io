...
<span style="font-family: Trebuchet MS; font-size: 16px; font: bold">📜\[2025.08\] We have released the <span style="color: #CD5C5C">[Youtu-GraphRAG](https://arxiv.org/pdf/2508.19855)</span> that vertically unifies the GraphRAG framework for advanced industrial implementation and also an anonymous dataset named 'AnonyRAG'.</span><br>
...
<span style="font-family: Trebuchet MS; font-size: 16px">📣[机器之心](), 📣[Tencent Cloud](https://mp.weixin.qq.com/s/Ddf3rpdJP8P_L5yaPnBFBA), 📣[Tencent YouTu Lab](), 📣[老刘说NLP](https://mp.weixin.qq.com/s/k39f3epLwnKimZ5Ui5DhKg)</span><br>
